...
const Quiz = () => {
    ...
    if(!quizData) {
        return (
            <Card className="mx-2">
                <CardHeader>
                    <CardTitle>Ready to test your knowledge?</CardTitle>                </CardHeader>
                <CardContent>
    ...
    return (
        ...
        <CardContent className="space-y-4">
            <p className="text-lg font-medium">{questions.question}</p>
            ...
            {showExplanation && <div className="mt-4 p-4 bg-muted rounded-lg">
                ...
                <p className="text-muted-foreground">{questions.explanation}</p>
                </div>}
        </CardContent>
        <CardFooter>
            {!showExplanation && (
